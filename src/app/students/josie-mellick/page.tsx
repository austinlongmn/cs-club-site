      ...
      <div style={{ height: 40, width: 1 }}></div>
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="text-center">
            ...
            {' ------ '}
            <Link href="https://www.linkedin.com/in/josie-mellick-60b430327?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BXxqV4ocSQjyo4ZAktwkKvQ%3D%3D" className="text-blue-400 hover:underline">
              LinkedIn
            </Link>
          </div>
        </div>
