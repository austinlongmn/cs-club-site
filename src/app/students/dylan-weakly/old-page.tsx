  ...
  return (
    <div className="max-w-8xl mx-auto mt-5 mb-10 flex flex-col items-center justify-center rounded-3xl border-8 border-[#428ad1] bg-neutral-800 p-10 text-white shadow-xl backdrop-blur-lg transition-all duration-500">
      <div className="flex w-full flex-col items-center justify-evenly px-10 md:flex-row md:items-center md:gap-10">
        ...
        <div className="flex flex-col items-center gap-2 text-center md:items-start md:text-left">
          ...
          <Link
            ...
            className="text-md hover:underline md:text-lg"
          >
            Connect on Linkedin
          </Link>
        </div>
      ...
      <div className="flex w-full flex-col items-center justify-evenly gap-10 px-4 md:w-2/3 md:flex-row">
        <div className="h-50 w-60 rounded-lg bg-neutral-500 p-4 text-center text-2xl md:h-50 md:w-70">
          Systems Analysis and Design Project
          <div className="mt-10">
            <Link
              href="dylan-weakly/systems-a-and-d"
              className="rounded-2xl bg-[#428ad1] px-5 py-4 font-semibold hover:cursor-pointer hover:bg-[#0d61b4]"
            >
              View Project
            </Link>
          </div>
        </div>
        <div className="h-58 w-60 rounded-lg bg-neutral-500 p-4 text-center text-2xl md:h-50 md:w-70">
          <h1 className="max-w-80">Python Haloween Trick-or-Treating App</h1>
          <div className="mt-10">
            <span className="cursor-not-allowed rounded-2xl bg-[#428ad1] px-3 py-4 font-semibold">
              No Link Available
            </span>
          </div>
        </div>
