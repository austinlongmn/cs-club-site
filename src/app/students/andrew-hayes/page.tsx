...
export default function Page() {
  return (
    <div className="min-h-screen bg-black p-6 text-white">
      ...
      <section className="mb-6 bg-gray-800 rounded-lg border-4 border-amber-600 p-4 transition-transform duration-300 ease-in-out hover:scale-110">
        <Link
      ...
      <section className="bg-gray-800 rounded-lg border-4 border-amber-600 p-4">
        <p className="mb-4 text-center text-blue-400 text-lg font-bold">
