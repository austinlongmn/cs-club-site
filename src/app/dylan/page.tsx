...
export const metadata: Metadata = {
    ...
    description:
        "Dylan Weakly's site for the UNWSP CS Club"
    };
    ...
    return ( 
        <Container bg="black">
            <Flex justifyContent="center" alignItems="center">
                <Heading size="3xl" color="white" py="5">Dylan Weakly</Heading>
            </Flex>
            <Box p={10} maxW="600px" mx="auto" bg="white" borderWidth="3px" borderColor="#16C2FF" shadow="md" rounded="3xl">
            <VStack align="start">
                ...
                <Text fontSize="md" color="black" py="2">
                    I am currently a sophomore Computer Science major with a Cybersecurity minor. 
                    I am currently learning web development with basic HTML, CSS, and JavaScript as well as learning the React framework.
                </Text>
                <Text fontSize="md" color="black" py="0" textAlign="right">
                    Some of my interests outside of Computer Science include going on hikes with my family (yeah, shocking!), checking out cool cars, and serving on the production team at my church.
                </Text>
